                    ...
                    <div id='coddeit' className="hero bg-white py-10  lg:p-10">
                        <div  className="hero-content flex-col px-10 lg:flex-row">
                            ...
                            <div className='max-w-sm mt-10 lg:mt-0 lg:ml-10 '>
                              ...
                              <a href="https://www.coddeit.site"> <button className='btn px-4 mt-4 p-2 bg-gradient-to-r from-yellow-400 to-orange-600 text-white font-bold'>Go to Site</button></a> 
                    ...
                    <div id='krypton' className="hero bg-white py-10  lg:p-10" >
                        <div className="hero-content flex-col px-10 lg:flex-row">
                            ...
                            <div className='max-w-sm mt-10 lg:mt-0 lg:ml-10 '>
                               ...
                               <a href="https://kryptonsite.netlify.app/"> <button className='btn px-4 mt-4 p-2 bg-gradient-to-r from-yellow-400 to-orange-600 text-white font-bold'>Go to Site</button></a>
                    ...
                    <div id='gamestore' className="hero bg-white py-10  lg:p-10">
                        <div className="hero-content flex-col px-10 lg:flex-row">
                            ...
                            <div className='max-w-sm mt-10 lg:mt-0 lg:ml-10 '>
                               ...
                               <a href="https://gamestoreforfun.netlify.app/"> <button className='btn px-4 mt-4 p-2 bg-gradient-to-r from-yellow-400 to-orange-600 text-white font-bold'>Go to Site</button></a>
                    ...
                    <div id='inlance' className="hero bg-white py-10  lg:p-10">
                        <div className="hero-content flex-col px-10 lg:flex-row">
                            ...
                            <div className='max-w-sm mt-10 lg:mt-0 lg:ml-10 '>
                                ...
                                <a href="https://ashishkolhe.netlify.app/"><button className='btn px-4 mt-4 p-2 bg-gradient-to-r from-yellow-400 to-orange-600 text-white font-bold'>Go to Site</button></a>
