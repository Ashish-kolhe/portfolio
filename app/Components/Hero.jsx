...
const Hero = () => {
  ...
  <div className="hero-content text-neutral-content text-center mt-14">
    <div className="">
     ...
     <a href="#projects"> <button className='btn mt-8 px-10 py-2 focus:outline-none bg-gradient-to-r from-yellow-400 to-orange-600 text-white text-lg font-bold'>PROJECTS</button></a>
